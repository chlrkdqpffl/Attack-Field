...
//	TwDefine(" TweakBar visible = true ");
	...
	// ------ Animation Option ----- //
	TwAddVarRW(g_tweakBar, "Bone Index", TW_TYPE_UINT32, &g_nBoneIndex, "group = AnimationOption");
	TwAddVarRW(g_tweakBar, "Animation Speed", TW_TYPE_FLOAT, &g_fAnimationSpeed, "group = AnimationOption step = 0.1");

	TwAddVarRW(g_tweakBar, "Offset X", TW_TYPE_FLOAT, &g_xmf3Offset.x, "group = AnimationOption step=0.005");
	TwAddVarRW(g_tweakBar, "Offset Y", TW_TYPE_FLOAT, &g_xmf3Offset.y, "group = AnimationOption step=0.005");
	TwAddVarRW(g_tweakBar, "Offset Z", TW_TYPE_FLOAT, &g_xmf3Offset.z, "group = AnimationOption step=0.005");

	TwAddVarRW(g_tweakBar, "Rotate X", TW_TYPE_FLOAT, &g_xmf3Rotate.x, "group = AnimationOption step=5");
	TwAddVarRW(g_tweakBar, "Rotate Y", TW_TYPE_FLOAT, &g_xmf3Rotate.y, "group = AnimationOption step=5");
	TwAddVarRW(g_tweakBar, "Rotate Z", TW_TYPE_FLOAT, &g_xmf3Rotate.z, "group = AnimationOption step=5");

	TwAddVarRW(g_tweakBar, "Quaternion X", TW_TYPE_FLOAT, &g_xmf3Quaternion.x, "group = AnimationOption step=0.1");
	TwAddVarRW(g_tweakBar, "Quaternion Y", TW_TYPE_FLOAT, &g_xmf3Quaternion.y, "group = AnimationOption step=0.1");
	TwAddVarRW(g_tweakBar, "Quaternion Z", TW_TYPE_FLOAT, &g_xmf3Quaternion.z, "group = AnimationOption step=0.1");
	TwAddVarRW(g_tweakBar, "Quaternion W", TW_TYPE_FLOAT, &g_xmf3Quaternion.w, "group = AnimationOption step=0.1");
	

	// Select Object
	TwAddVarRW(g_tweakBar, "Select Position X", TW_TYPE_FLOAT, &g_xmf3SelectObjectPosition.x, "group = SelectObject step=0.1");
	TwAddVarRW(g_tweakBar, "Select Position Y", TW_TYPE_FLOAT, &g_xmf3SelectObjectPosition.y, "group = SelectObject step=0.1");
	TwAddVarRW(g_tweakBar, "Select Position Z", TW_TYPE_FLOAT, &g_xmf3SelectObjectPosition.z, "group = SelectObject step=0.1");

	TwAddVarRW(g_tweakBar, "Select Rotate X", TW_TYPE_FLOAT, &g_xmf3SelectObjectRotate.x, "group = SelectObject step=5");
	TwAddVarRW(g_tweakBar, "Select Rotate Y", TW_TYPE_FLOAT, &g_xmf3SelectObjectRotate.y, "group = SelectObject step=5");
	TwAddVarRW(g_tweakBar, "Select Rotate Z", TW_TYPE_FLOAT, &g_xmf3SelectObjectRotate.z, "group = SelectObject step=5");

	TwAddVarRW(g_tweakBar, "Select Number", TW_TYPE_INT32, &g_nSelect, "group = SelectObject");
...
//	g_OptionHDR.g_fDOFFarStart = 40.0f;
	g_OptionHDR.g_fDOFFarStart = 500.0f;
