...
CTerroristPlayer::~CTerroristPlayer()
{
}

void CTerroristPlayer::CreateMesh(ID3D11Device *pd3dDevice)
{
...
void CTerroristPlayer::CreateShader(ID3D11Device *pd3dDevice)
{
...
void CTerroristPlayer::CreateMaterial()
{
