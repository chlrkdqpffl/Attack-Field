...
VS_Terrain_Output VS(VS_Terrain_Input vin)
{
    VS_Terrain_Output vout = VS_Terrain_Output(0);
...
PatchTess ConstantHS(InputPatch<VS_Terrain_Output, 4> patch, uint patchID : SV_PrimitiveID)
{
    PatchTess pt;
