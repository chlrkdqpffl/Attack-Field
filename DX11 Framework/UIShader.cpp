...
void CUIShader::CreateShader(ID3D11Device *pd3dDevice)
{
	...
	CreateVertexShaderFromFile(pd3dDevice, L"../Shader HLSL File/RenderToScreen.hlsli", "VSTextureToScreen", "vs_5_0", &m_pd3dVertexShader, d3dInputElements, nElements, &m_pd3dVertexLayout);
	CreatePixelShaderFromFile(pd3dDevice, L"../Shader HLSL File/RenderToScreen.hlsli", "PSTextureToScreen", "ps_5_0", &m_pd3dPixelShader);
}
