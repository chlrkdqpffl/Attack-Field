...
void CMainScene::CreateUIImage()
{
	...
	POINT aimingPos = POINT{ FRAME_BUFFER_WIDTH / 2 + 3, FRAME_BUFFER_HEIGHT / 2 - 22};		// ¿ÀÇÁ¼Â (3, -14)			// +°¡ ¿À¸¥ÂÊ, +°¡ ¾Æ·¡ÂÊ
...
void CMainScene::RenderAllText(ID3D11DeviceContext *pd3dDeviceContext)
{
	...
	str = "¿øÁ¡À¸·ÎºÎÅÍÀÇ °Å¸® : (" + to_string(XMVectorGetX(temp)) + ")\n";		// 3D »ç¿îµå ¿ë
